  ...
  return (
    <div className=" flex justify-between my-10 gap-2 md:gap-4 lg:gap-8">
      <form className="flex relative w-2/3 md:w-3/4 lg:w-4/5">
        <input
          type="text"
          className="border-[3px] text-title border-[#71416D] placeholder:text-title rounded-xl pr-6 py-3 lg:py-4 placeholder:font-normal w-full shadow-product-card focus:outline-none z-30"
