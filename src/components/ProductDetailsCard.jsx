...
function ProductDetailsCard({ product }) {
  return (
    <div className="px-10 py-8 shadow-main-page w-full rounded-4xl sticky top-20  ">
      <div className="flex flex-col justify-between gap-5 ">
        <h3 className="text-black text-base lg:text-3xl font-bold">جزئیات:</h3>

        <div className="flex flex-col gap-4 lg:gap-6 text-xs lg:text-base font-bold text-text-color">
          <p>
            {" "}
      ...
      <div className="flex justify-center items-center mt-3 lg:mt-12   ">
        <Link href={product.file_path} target="_blank">
          <SimpleButton additionalStyles="px-4 lg:px-6 py-2 lg:py-4 rounded-2xl text-xs  lg:text-2xl font-semi-bold">
            دانلود قالب
          </SimpleButton>
        </Link>
      </div>
