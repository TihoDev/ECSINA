      ...
      <div className="xl:px-12 section-shadows xl:py-10 2xl:py-12 2xl:px-24 relative overflow-hidden flex  gap-14 md:gap-0 justify-between items-center bg-secondary-background rounded-full mt-20 ">
        ...
        <div className="relative lg:hidden py-12 sm:pr-12">
          ...
          <div className="flex justify-center items-center">
            ...
            <div className="absolute top-[25px] -translate-y-1/12">
              <Border size={230} />
            </div>
            <div className="absolute top-[15px] -translate-y-1/12">
              <Border size={260} />
            </div>
          </div>
        </div>
        ...
        <div className="relative ">
          <div className="flex flex-col items-end gapy-1 lg:gap-y-10 ml-10 lg:ml-16 ">
            <p className="text-[14px] sm:text-[20px] mb-4 lg:text-3xl font-extrabold text-secondary-title leading-6 lg:leading-12 ">
          ...
          <div className=" lg:invisible flex items-center justify-center ">
            <div className="absolute top-12/12 -left-2/10">
              <Border size={90} />
            </div>
            <div className="absolute top-10/12 -left-3/10">
              <Border size={120} />
            </div>
          </div>
        </div>
        ...
        {/* MOBILE */}
        <div className=" lg:invisible  absolute -top-7 left-25">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="150"
            height="90"
