    ...
    <div className="container relative overflow-hidden flex  gap-14 md:gap-0 justify-between  items-center bg-secondary-background rounded-full mt-20 ">
      ...
      <div className="relative lg:hidden ">
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="absolute -top-7/24">
            <Border size={230} />
          </div>
          <div className="absolute -top-9/24">
            <Border size={260} />
          </div>
        </div>
      </div>
      ...
      <div className="relative ">
        <div className="flex flex-col items-end gapy-1 lg:gap-y-10 ml-10 lg:ml-16 ">
          <p className="text-[8px] lg:text-3xl font-extrabold text-secondary-title leading-4 lg:leading-12 ">
