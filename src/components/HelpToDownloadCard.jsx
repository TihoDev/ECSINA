...
const HelpToDownloadCard  = () => {
    return(
        <div className='absolute left-15 top-[510px] z-40 rounded-4xl bg-[#FFF6FE] w-[500px] p-10 shadow-lg'>
            ...
            <p className='font-normal text-[15px] mb-8'>اکسین در این بخش، مجموعه‌ای از قالب‌های حرفه‌ای و استاندارد را برای دانلود رایگان در اختیار شما قرار می‌دهد تا بتوانید به‌راحتی و بدون هزینه از آن‌ها در پروژه‌های خود استفاده کنید.
            ...
            <h2 className='text-[20px] font-bold mb-4 leading-8'>  نحوه دانلود و استفاده</h2>
            <p className='mb-8 font-semibold text-[14px] leading-8'>
            ...
            <p className="font-semibold text-[14px] leading-8">
