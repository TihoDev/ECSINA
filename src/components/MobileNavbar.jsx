...
const MobileNavbar = ({ navigationLinks }) => {
  ...
  return (
    <>
      ...
      <div>
        <ul
          className="fixed translate-x-[100%] bg-gradient-to-r from-[#FFFFFF] to-[#FEF1FD] top-0 pt-8 px-6 sm:px-7 lg:pr-0 ease-in duration-200 w-2/5 h-full shadow-xl rounded-bl-[50px] [&>li]:cursor-pointer z-50 font-semibold"
          ref={menu}
        >
