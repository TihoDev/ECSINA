...
<<<<<<< HEAD
        <div className="p-4 rounded-md  max-w-[64px] flex items-center justify-center gradient-cart-icon">
          <Image src={product.icon} alt={product.title} className="inline-flex" width={20} height={20} />
=======
...
>>>>>>> dev
      ...
      {/* Mobile */}
<<<<<<< HEAD
      <div className="p-3 md:hidden rounded-md flex flex-col gap-2 items-center justify-center min-w-24 sm:min-w-44" style={{ backgroundImage: "var(--gradient-cart-icon)" }}>
        <Image src={product.icon} alt={product.title} width={20} height={20} />
=======
      <div
