        ...
        <div className='w-[288px] h-[344px] rounded-4xl flex flex-col shadow-[0px_2px_4px_0px_#1E132840]'>
            ...
            <div className='p-4'>
                <div className='flex flex-col w-[206px]'>
                    <h1 className='font-semibold text-2xl leading-9 mb-2'>بوم كسب و كار</h1>
                    <p className='font-normal text-base leading-6'>ابزاری برای تجزیه و تحلیل و بهینه سازی مدل های کسب و کار است .</p>                    
                </div>
